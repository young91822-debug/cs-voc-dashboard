...
def build_monthly_insight(df_):
    # 반환: (headline, bullets(list[str]), kpis(dict))
...
# AI처럼 보이게: “문장 1 + 핵심 bullet 3 + KPI 3개”
st.markdown(
    f"""
<div class="card">
  ...
  <div class="ai-foot">
    ※ 이 요약은 “현재 선택 조건” 기준으로 월간 변화를 자동 정리한 것입니다. (전월 0건인 항목은 % 대신 ‘-’로 표시)
  </div>
</div>
""",
    unsafe_allow_html=True,
